    ...
    def train(self, exp_schedule, lr_schedule):
        ...
        while t < 2000:
            ...
            while True:
                ...
                # embedding = self.sess.run(self.hiddenA, feed_dict={self.s: [q_input]})[0]
                embedding = self.sess.run(self.hiddenV, feed_dict={self.s: [q_input]})[0]
                ...
                scipy.misc.imsave('embeddings/breakoutA/breakout{}.png'.format(t),frame)
                np.save('embeddings/breakoutA/breakout_input{}.npy'.format(t),q_input)
        ...
        np.save(open('embeddings/breakoutA/breakout.npy','w'),np.vstack(embeddings))
